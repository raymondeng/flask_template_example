...
original_name="flask_template_example"
original_urlname="flask_template_example"
original_description="Awesome flask_template_example created by raymondeng" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/flask_template_example "${name}"
...
then
    ...
    echo "then run 'flask_template_example' or 'python -m flask_template_example'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flask_template_example' or 'python -m flask_template_example' or 'poetry run flask_template_example'"
fi
